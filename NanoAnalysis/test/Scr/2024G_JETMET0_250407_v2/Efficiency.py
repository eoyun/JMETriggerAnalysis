...
def analysis(filename_idx,idx,outputdir):
    ...
    #df = df.Define("Trig_obj_pt","TrigObj_pt[TrigObj_id == 1 && (TrigObj_filterBits & 32) != 0]")
    #df = df.Define("hlt_Jet_eta","TrigObj_eta[TrigObj_id == 1 && (TrigObj_filterBits & 32) != 0]")
    #df = df.Define("hlt_Jet_phi","TrigObj_phi[TrigObj_id == 1 && (TrigObj_filterBits & 32) != 0]")
    #df = df.Define("hlt_Jet_id","TrigObj_filterBits[TrigObj_id==1&& (TrigObj_filterBits & 32)  != 0]")
    ...
    _hitso_tag_id      = df.Histo1D(("h_id_tag",";x-axis;y-axis",100,0,100), "tag_jet_id")
    _hitso_probe_id    = df.Histo1D(("h_id_probe",";x-axis;y-axis",100,0,100), "probe_jet_id")
    ...
    _after_hitso_tag_id      = df_after.Histo1D(("h_after_id_tag",";x-axis;y-axis",100,0,100), "tag_jet_id")
    _after_hitso_probe_id    = df_after.Histo1D(("h_after_id_probe",";x-axis;y-axis",100,0,100), "probe_jet_id")
    ...
    _after_histo_tag_id.Write()
    _after_histo_probe_id.Write()
