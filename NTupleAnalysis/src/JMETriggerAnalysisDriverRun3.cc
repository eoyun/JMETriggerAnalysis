...
bool JMETriggerAnalysisDriverRun3::isLeadingJet(){
  auto const& leadingJetEta = fabs((this->vector<float>("offlineAK4PFPuppiJetsCorrected_eta"))[0]);
  return leadingJetEta > 3.0;
}
